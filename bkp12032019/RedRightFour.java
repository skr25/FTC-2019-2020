...
@Autonomous(name="Red Right Four", group="RedAlliance")

public class RedRightFour extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException { //runs when you select program initialization
       ...
       MoveRobotBackwardForSeconds(0.9);
       MoveRobotRightForSeconds(1.25);
...
public void GoToFoundationDropStoneFirstScan(){
     ...
     telemetry.update();
     MoveRobotLeftForSeconds(2.8);
     SpinClockwiseRobotForSeconds(1.6); //(1.15)
     FTCRobot.Default_Motor_Power = 1 ;
