...
@Autonomous(name="Red Left One Position Alli. Stable Perimeter", group="RedAlliance")

public class RedLeftOneAStableBridge extends LinearOpMode {
...
public void IdentifySkystoneAndKick(){
    ...
    telemetry.update();
    MoveRobotBackwardForSeconds(0.3);
...
public void GoToFoundationDropStoneFirstScan(){
     ...
     SpinClockwiseRobotForSeconds(2); //prev 1.7
     FTCRobot.Default_Motor_Power = 1 ;
    ...
    //removes block from arm clutches
     ...
     MoveRobotBackwardForSeconds(1.6);
