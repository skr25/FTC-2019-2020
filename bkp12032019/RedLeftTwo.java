...
public class RedLeftTwo extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException { //runs when you select program initialization
       ...
       //Get and assign all hardware data into variables
        ...
        TensorFlowMineral myObjTensorFlow = new TensorFlowMineral(telemetry,hardwareMap);
        // Wait for the game to start (driver presses PLAY)
        waitForStart();
        // create a Robot object from MyRobot class
        ...
        FTCRobot.Default_Motor_Power = 0.25;
        MoveRobotLeftForSeconds(1);
        SpinCounterClockwiseRobotForSeconds(3);
        MoveRobotForwardForSeconds(1);
        //setting power to default and retracting elevator to normal position
        FTCRobot.Default_Motor_Power = defaultRobotPower;
